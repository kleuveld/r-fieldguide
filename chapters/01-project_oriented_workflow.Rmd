...
This chapter discusses two R-specific aspects of project-oriented workflows:
the project folder and the renv package.
I also recommend using git, but that goes beyond the scope of this field guide.
...
(leaving out the bits where she threatens to set your PC on fire):
...
How exactly you organize this project folder,
and how you name your files etc., is entirely up to you.
However, if the structure is complex, 
do use a README file to point the way for others to the files they need.
...
This path will work wherever the calling script,
...
(at WUR, research data is not supposed to be on git).
...
so make sure to describe this in your README file.
...
However, you should not stay at an old version of a package for all your work,
